...
export function UserOffcanvas({ setShowSiteClickAlart, panel}) {
                        ...
                        <div className="mx-auto max-w-7xl px-2">
                            ...
                            <div className='rounded-lg bg-gray-800'>
                                <div className="relative flex justify-between h-16 w-[600px]">
                                    ...
                                    <button className='w-28 my-3 bg-blue-600 text-white rounded-xl text-s text-nowrap'
                                            onClick={() => setShowCreateUserModal(true)}>+ Створити
                                    </button>
                                    {showCreateUserModal &&
                                        <CreateUserModal panel={panel} onClose={() => setShowCreateUserModal(false)} />}
                                </div>
                            </div>
                        </div>
